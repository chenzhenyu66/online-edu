<template>
  <div>
    ...
    <div class="block">
      ...
      <el-carousel trigger="click" height="470px" style="margin: 0 auto; text-align: center">
                  ...
                  <div  class="cc-l-wrap">
                    ...
                    <section class="mt10 hLh20 of">
                      <span class="fr jgTag bg-green">
                        ...
                        <i class="c-fff fsize12 f-fA" v-else="">{{ course.price }}元</i>
                      </span>
                  ...
                  <section class="i-teach-wrap">
                    <div class="i-teach-pic">
                      <a :href="'/teacher/' + teacher.id" :title="teacher.name">
                        <img :alt="teacher.name" :src="teacher.avatar" style="height: 160px "/>
                      </a>
                    </div>
...
export default {
  ...
  methods: {
    ...
    // 拿到所有课程信息
    getCourseList(){
      course.getCourseToList().then(response => {
        this.courseList = response.data.items
      })
    },
    // 拿到所有教师信息
    getTeacherList(){
      teacher.getTeacherToList().then(response => {
